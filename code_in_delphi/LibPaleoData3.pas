...
uses
  ...
  Function my_decompress(var source: file; dest_stream: PPByte; resulting_total_size: Pcsize_t):integer; cdecl; external;
...
Constructor TPaleoClimate.Create(PLASIMFile,
 ...
 var
  ...
  arq_source: file of Byte;

  i, j, k, c: Integer;
  stream_final_size: csize_t;
 begin
   ...
   Assign(arq_source,PLASIMFile);
   reset(arq_source);
   Stream:= TMemoryStream.Create;
   write('linha 430');
   my_decompress(arq_source, @Stream, @stream_final_size);
